              ...
              {items.map((item, idx) => (
                <tr key={idx} className="border-t border-border">
                  <td className="px-2 py-1.5">
                    <Select value={item.product_id || 'none'} onValueChange={v => v !== 'none' && handleProductSelect(idx, v)}>
                  ...
                  <td className="px-1 py-1.5">
                    <Input
                      ...
                      onChange={e => updateItem(idx, { ordered_boxes: Math.max(1, Number(e.target.value) || 1) })}
                    />
                  </td>
                  <td className="px-1 py-1.5">
                    <Input
                  ...
                  <td className="px-1 py-1.5">
                    <Input
                      ...
                      className="h-8 text-xs text-right w-full"
                      value={item.tax_pct}
                      onChange={e => updateItem(idx, { tax_pct: Number(e.target.value) || 0 })}
                    />
                  </td>
